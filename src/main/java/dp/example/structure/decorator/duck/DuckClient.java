...
import dp.example.structure.adapter.duck.Duck;
import dp.example.structure.adapter.duck.Duckling;
...
public class DuckClient {
    ...
    public void testDuckAdapter() {
        ...
        Duck uglyDuckling = new dp.example.structure.adapter.duck.UglyDuckling();
        uglyDuckling.cry();
